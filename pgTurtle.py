...
class _C:
    def __getattribute__(self, name):
        try:
            ...
            return type(self)
TK = _C() # Aby się dało dziedziczyć z jego klas
...
class ScrolledCanvas(TK.Frame):
    ...
    def __init__(self, master, width=500, height=350,
        ...
        raise NotImplementedError('Nie można użyć w tym wydaniu. Spróbuj w module turtle')
...
class _Root:
    ...
    def __init__(self):
        pygame.init()
        self._screen = None
        self._destroy = lambda: pygame.quit()

    def setupcanvas(self, width, height, cwidth, cheight):
        self._screen = pygame.display.set_mode(width, height, cwidth, cheight)
